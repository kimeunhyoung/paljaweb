...
window.SITE_BUSINESS = {
  ...
  /** 사업자등록증 기재 유선 (카드사·PG 심사 필수) */
  landline: '051-925-0441',
  /** 팔자연구소 상담·문의 전용 */
  phone: '010-8674-8481',
...
window.SITE_BUSINESS_HTML = [
  ...
  '유선번호 ' + window.SITE_BUSINESS.landline + ' · 휴대폰 ' + window.SITE_BUSINESS.phone + ' · 이메일 <a href="mailto:' + window.SITE_BUSINESS.email + '">' + window.SITE_BUSINESS.email + '</a>',
].join('<br>');
