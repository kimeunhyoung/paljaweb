...
const CHEAT_STYLE =
  ...
  '일상어(「성공 부스터」「위험 경고등」「관계 부스터」)로만. DO/DON\'T 필수. 이모지·「상위 1%」 과장 금지.\n' +
  '3) Part B: Part A와 **같은 결론**을 차트 근거로 짧게 설명. 여기서는 행성·별자리·하우스·어스펙트 이름을 써도 됨. ' +
  '다만 각 근거 뒤에 쉬운 말을 한 번 붙이세요. 섹션당 문장 2~4개 또는 불릿 3~5개. 예전처럼 긴 보고서 금지.\n' +
  '4) [출생 차트]에 있는 배치만 근거. 없는 배치를 지어내지 마세요. 이름은 차트에 있으면 그대로, 없으면 「당신」.\n' +
  '5) Part A와 Part B가 서로 모순되지 않게. 같은 내용 복붙 금지.';
