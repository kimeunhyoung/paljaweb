...
const LIFECODE_ONETIME_PRODUCTS = {
  basic30: {
    ...
    title: '베이직 15일 이용권',
    desc: '로그인 계정에 바로 연결 · 기기 최대 4대 · 15일간 라이프코드 단품 리포트. 계속 이용하실 때는 월 9,900원 구독을 추천합니다.',
  },
  counselor30: {
    key: 'counselor30',
    amount: 29900,
    ...
    title: '상담사 15일 체험권',
    desc: 'Professional 전 기능 15일 · AI 월 25회 · 로그인 계정에 바로 연결 · 기기 최대 4대 · 1회 29,900원',
  },
};
...
async function linkLicenseToAccount(license, userId, product, deps = {}) {
  ...
  if (product?.productTier === 'counselor' && typeof deps.patchProfileFields === 'function') {
