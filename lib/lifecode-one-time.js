...
const LIFECODE_ONETIME_PRODUCTS = {
  basic30: {
    ...
    title: '베이직 15일 이용권',
    desc: '접속 코드 1개 · 기기 1대 · 15일간 라이프코드 단품 리포트(구독 없음). 계속 보려면 월 9,900원 구독이 더 저렴합니다.',
  },
  counselor30: {
    key: 'counselor30',
    amount: 29900,
    ...
    title: '상담사 15일 체험권',
    desc: '체험 포함: 전체 심층 분석 + 간이 상담사 허브(고객 카드 저장·분석 열기·메모, 기기 1대) · 15일 1회 결제 / 구독 전용(미포함): 상담기록(CRM)·대시보드 통계·일정 캘린더·푸시 알림·브랜디드 리포트 PDF·CSV 백업·다기기 동기화',
  },
};
...
function registerLifecodeOneTimeRoutes(app, { portoneConfigured, portonePublicConfig, portoneOneTimePublicConfig, lifecodeConfigured }) {
