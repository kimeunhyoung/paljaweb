...
const LIFECODE_ONETIME_PRODUCTS = {
  basic30: {
    ...
    title: '베이직 15일 이용권',
    desc: '로그인 계정 · 기기 최대 4대 · 15일간 라이프코드 단품 리포트(구독 없음). 계속 이용하실 때는 월 9,900원 구독을 추천합니다.',
  },
  counselor30: {
    key: 'counselor30',
    amount: 29900,
    ...
    title: '상담사 15일 체험권',
    desc: 'Professional 전 기능 15일(상담사 허브·CRM·캘린더·푸시·PDF 포함) · AI 크레딧 월 25회(정식 Pro 120회와 다름) · 팔자연구소 로그인 계정 · 기기 최대 4대 · 1회 29,900원',
  },
};
