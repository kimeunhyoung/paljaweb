...
const LIFECODE_ONETIME_PRODUCTS = {
  basic30: {
    ...
    title: '베이직 7일 이용권',
    desc: 'Basic 기능과 동일 · AI 5크레딧(월 Basic 구독은 10) · 7일. 계속 이용하실 때는 월 9,900원 구독을 추천합니다.',
  },
  counselor30: {
    key: 'counselor30',
    amount: 29900,
    ...
    title: '상담사 15일 체험권',
    desc: 'Professional 전 기능 · AI 25크레딧 · 15일. 계속 이용하실 때는 Professional 월 구독(출시가 29,900원 · 정식가 49,900원)을 추천합니다.',
  },
};
