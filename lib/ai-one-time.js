...
const AI_ONETIME_PRODUCTS = {
  ai_chart: {
    ...
    title: '점성학 AI 차트 해석',
    desc: '점성학 「AI 차트 해석」용 2크레딧. 타고난 성향(출생 차트) AI 해설. 올해·이번 주 운세는 포함되지 않습니다. 필요할 때 다시 구매할 수 있습니다.',
  },
  ai_fortune: {
    key: 'ai_fortune',
    amount: 2500,
    ...
    title: '점성학 AI 운세 체험팩',
    desc: '점성학용 AI 6크레딧(기간 제한 없음·소진까지). 예: 차트 해석(2) + 올해 운세(1) + 이번 주 운세(1) + 오늘 운세(1) + 여유 1. 다시 구매 가능.',
  },
  cal_pass_3d: {
    key: 'cal_pass_3d',
    amount: 1900,
