...
const AI_ONETIME_PRODUCTS = {
  ai_2: {
    ...
    orderName: 'AI 크레딧 +2',
    title: 'AI 크레딧 +2',
    desc: '맛보기. 짧은 운세·오늘 흐름 등 1크레딧 AI 2회. 차트(3)·커플(4)은 +5 이상 권장.',
  },
  ai_5: {
    key: 'ai_5',
    amount: 2000,
    ...
    orderName: 'AI 크레딧 +5',
    title: 'AI 크레딧 +5',
    desc: '점성학·수비학 공통. +2보다 단가 유리. 예: 차트(3)+운세 2회, 또는 커플 궁합(4)+여유 1.',
  },
  ai_10: {
    key: 'ai_10',
    amount: 2500,
    ...
    orderName: 'AI 크레딧 +10',
    title: 'AI 크레딧 +10',
    desc: '가장 저렴한 단가. +5 두 번(4,000원)보다 훨씬 쌈. 점성학·수비학 공통(구독 시 네임코드 AI도).',
  },
  cal_pass_3d: {
    key: 'cal_pass_3d',
    amount: 1900,
...
async function fulfillAiCreditOrder(paymentId) {
  ...
  // pending → paid 선점 후 지급 (confirm+webhook 동시 호출 시 이중 지급 방지)
