...
const AI_ONETIME_PRODUCTS = {
  ai_chart: {
    ...
    title: 'AI 차트 해석 1회',
    desc: '점성학 AI 차트 해석 1회분(2크레딧). 로그인 계정에 바로 지급 · 자동 갱신 없음. 자주 쓰면 Basic 월 구독(9,900원·10크레딧)이 더 이득입니다.',
  },
  ai_fortune: {
    key: 'ai_fortune',
    amount: 2900,
    ...
    orderName: 'AI 운세 체험팩',
    title: 'AI 운세 체험팩',
    desc: 'AI 크레딧 5회(차트 해석·트랜짓·올해 운세 등). 로그인 계정에 바로 지급 · 자동 갱신 없음. 마음에 들면 월 구독으로 이어가세요.',
  },
};
